...
@interface CLHNewViewController () <UIScrollViewDelegate>
...
@implementation CLHNewViewController
...
- (void)tagClick{
    ...
    CLHSubTableViewController *subVC = [[CLHSubTableViewController alloc] init];
